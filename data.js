const flareQuillsData = {
    "flare_quills": [
        ...
        {
            "id": "101.png",
            "name": "Frostbore Figure",
            "occupation": "Guardian",
            "element": "Ice",
            "tribe": "Tideborn Covenant",
            "region": "Frozen Fjords",
            "ember_cost": 5,
            "attack_action": "Frost Nova - Releases a chilling wave that freezes everything in its path.",
            "origin_story": "An ancient construct of permafrost and crystalline aether, designed to guard the gates of the Frozen Fjords.",
            "powers": [
                "Ice Shard",
                "Frost Nova"
            ],
            ...
            "action": "Chilling Blast",
            "story": "A silent protector carved from the eternal ice of the north.",
            "resources": [
                "Ice Crystal",
                "Snowball"
            ],
        ...
        {
            "id": "102.png",
            "name": "Storm-Frost Arbiter",
            "occupation": "Stormguard",
            "element": "Ice/Electric",
            "tribe": "Storm Vanguard",
            "region": "Thunder Peaks",
            "ember_cost": 6,
            "attack_action": "Blitz-Freeze - Strikes with lightning bolts that encase the target in conductive ice.",
            "origin_story": "Born where the freezing winds of the Fjords meet the eternal storms of the Peaks, this warrior channels both frost and flash.",
            "powers": [
                "Static Chill",
                "Chain Frost-Volt"
            ],
            ...
            "action": "Thunder Frost Strike",
            "story": "A rare hybrid warrior capable of freezing enemies before shattering them with high-voltage strikes.",
            "resources": [
                "Fulgerite Ice",
                "Copper Frost"
            ],
        ...
        {
            "id": "103.png",
            "name": "Volt-Crest Sovereign",
            "occupation": "High Lord",
            "element": "Electric",
            "tribe": "Storm Vanguard",
            "region": "Thunder Peaks",
            "ember_cost": 7,
            "attack_action": "Gigavolt Discharge - Unleashes a massive wave of pure electrical energy.",
            "origin_story": "Forged in the heart of the most violent supercell ever recorded, this being is pure living electricity.",
            "powers": [
                "Lightning Strike",
                "Overload Field"
            ],
            ...
            "action": "Omni-Flash",
            "story": "A terrifying force of nature that can vaporize armor with a single touch.",
            "resources": [
                "Pure Quartz",
                "Copper Ore"
            ],
        ...
        {
            "id": "104.png",
            "name": "Aether-Vortex Manipulator",
            "occupation": "Energy Sage",
            "element": "Void/Air",
            "tribe": "Mystic Enclave",
            "region": "Arcane Sanctum",
            "ember_cost": 6,
            "attack_action": "Spiral Singularity - Creates a rotating vortex that pulls particles into a crushing center.",
            "origin_story": "A master of the swirling currents that flow between dimensions, capable of bending raw aether into geometric spirals.",
            "powers": [
                "Vortex Pull",
                "Centrifugal Burst"
            ],
            ...
            "action": "Vortex Spin",
            "story": "Uses rhythmic circular motions to channel high-density energy into devastating projectiles.",
            "resources": [
                "Aether Dust",
                "Prism Shard"
            ],
        ...
        },
        {
            ...
            "region": "Geode Caverns",
            "ember_cost": 5,
            "attack_action": "Lithic Psalm - Chants a geological hymn that causes jagged rocks to erupt from the ground.",
            "origin_story": "A high-ranking official in the Crystalline Guard, responsible for the spiritual and structural integrity of the Geode Caverns.",
            "powers": [
                "Earthen Shield",
                "Jagged Burst"
            ],
            ...
            "action": "Sedimentary Strike",
            "story": "Uses ancient lithic scrolls to command the very foundation of the world.",
            "resources": [
                "Obsidian",
                "Iron Ore"
            ],
        ...
        {
            "id": "106.png",
            "name": "Xylos the Astro-Beholder",
            "occupation": "Star-Navigator",
            "element": "Void/Cosmic",
            "tribe": "Cosmic Outcasts",
            "region": "Stellar Nexus",
            "ember_cost": 8,
            "attack_action": "Crystal Singularity - Fires a beam from its central gem that traps enemies in a gravity well.",
            "origin_story": "An exile from beyond the known stars, Xylos arrived in a suit of ancient living crystal that channels the background radiation of the universe.",
            "powers": [
                "Photon Barrage",
                "Gravity Warp"
            ],
            ...
            "action": "Star-Gaze Beam",
            "story": "A being of pure intellect and crystal tech, watching the world through its many cybernetic eyes.",
            "resources": [
                "Star Matter",
                "Alien Alloy"
            ],
